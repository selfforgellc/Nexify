    ...
    <div>
      ...
      {hasSynced && connectorId === 'slack' && (
        <div style={{ fontSize: 10, color: 'var(--color-text-tertiary)', marginTop: 4 }}>
          Tip: invite the bot to channels with /invite @nexify, then re-sync
        </div>
      )}
      {syncError && (
        <div style={{ fontSize: 11, color: 'var(--color-error)', marginTop: 4 }}>
...
const MESSAGING_CHANNELS: MessagingChannelConfig[] = [
  {
    ...
    setupSteps: [
      ...
      'COPYABLE:{"display_information":{"name":"nexify"},"features":{"app_home":{"home_tab_enabled":true,"messages_tab_enabled":true,"messages_tab_read_only_enabled":false},"bot_user":{"display_name":"nexify","always_online":true}},"oauth_config":{"scopes":{"bot":["chat:write","im:write","im:read","im:history","mpim:read","mpim:history","users:read","channels:read","channels:history","channels:join","groups:read","groups:history","app_mentions:read"]}},"settings":{"event_subscriptions":{"bot_events":["message.im"]},"socket_mode_enabled":true}}',
      ...
      '6. (Optional) Still in "Basic Information", scroll to "Display Information" \u2192 upload the nexify icon as the app icon',
    ...
    howToUse: () => 'Open Slack and DM @nexify to talk to your agent.',
  },
];
