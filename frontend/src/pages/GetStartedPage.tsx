...
const GITHUB_BASE =
  'https://github.com/open-jarvis/nexify/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/open-jarvis/nexify.git\ncd nexify\nuv sync"} />
