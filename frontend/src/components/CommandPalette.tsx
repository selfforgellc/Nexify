...
const CLOUD_PROVIDERS: CloudProvider[] = [
  ...
  },
  {
    ...
    storageKey: 'nexify-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'nexify-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to nexify servers</span>
          )}
        </div>
      </div>
    </div>
