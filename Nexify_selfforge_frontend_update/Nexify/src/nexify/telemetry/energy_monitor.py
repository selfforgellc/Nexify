...
def create_energy_monitor(
    ...
    try:
        from nexify.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from nexify.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from nexify.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from nexify.telemetry.energy_rapl import RaplEnergyMonitor
