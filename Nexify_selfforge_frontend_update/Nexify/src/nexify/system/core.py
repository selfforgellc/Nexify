...
if TYPE_CHECKING:
    ...
    from nexify.channels._stubs import BaseChannel
    from nexify.learning._stubs import RouterPolicy
    ...
    from nexify.speech._stubs import SpeechBackend
...
class JarvisSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~nexify.channels._stubs.BaseChannel`
            instance whose ``on_message`` method accepts a callable.
        """
        from nexify.core.types import Message
        from nexify.sessions.session import SessionStore
