...
from nexify.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """nexify support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "Validation tracked in open-jarvis/nexify#316."
        ),
    ),
    PearlModelSpec(
        ...
        notes=(
            "Experimental nexify/Pearl artifact validated on H100. "
    ...
    PearlModelSpec(
        ...
        notes=(
            "Planned target; Pearl artifact is not publicly available yet. "
            "Validation tracked in open-jarvis/nexify#317."
        ),
    ),
    PearlModelSpec(
        ...
        notes=(
            "Planned target; Pearl artifact is not publicly available yet. "
            "Validation tracked in open-jarvis/nexify#318."
        ),
    ),
    PearlModelSpec(
        ...
        notes=(
            ...
            "Validation tracked in open-jarvis/nexify#319."
        ),
    ),
    PearlModelSpec(
        ...
        default_max_model_len=8192,
        notes=(
            "Experimental nexify/Pearl artifact validated on H100 with "
