"""LLM-based optimizer for nexify configuration tuning.

Uses a cloud LLM to propose optimal nexify configs, inspired by DSPy's
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal nexify configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an nexify AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this nexify evaluation result.")
        lines.append("")
