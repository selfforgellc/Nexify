...
``~/.nexify/learning/skills/<skill-name>/optimized.toml``.
...
from nexify.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from nexify.core.config import DSPyOptimizerConfig
        from nexify.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from nexify.learning.agents.gepa_optimizer import GEPAAgentOptimizer
