...
Adapted from IPW's ``environment.py``.  Uses nexify's
:class:`~nexify.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via nexify ``ToolExecutor``.
