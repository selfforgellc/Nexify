...
- **Environment**: RL environment using nexify ToolExecutor
...
``orchestrator_grpo`` in :class:`~nexify.core.registry.LearningRegistry`.
"""
...
from nexify.learning.intelligence.orchestrator.sft_trainer import (
