...
Routes incoming :class:`~nexify.channels._stubs.ChannelMessage` objects
...
from nexify.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in nexify:\nnexify://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~nexify.agents._stubs.BaseAgent`
        subclass).
    max_workers:
