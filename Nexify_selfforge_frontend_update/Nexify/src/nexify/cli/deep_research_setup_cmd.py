...
def _instantiate_connector(connector_id: str, config: Dict[str, Any]) -> Any:
    ...
    if connector_id == "apple_notes":
        from nexify.connectors.apple_notes import AppleNotesConnector

        return AppleNotesConnector(db_path=config.get("db_path", ""))
    elif connector_id == "imessage":
        from nexify.connectors.imessage import IMessageConnector
        ...
        from nexify.connectors.gmail_imap import GmailIMAPConnector
        ...
        from nexify.connectors.slack_connector import SlackConnector

        return SlackConnector()
    elif connector_id == "notion":
        from nexify.connectors.notion import NotionConnector

        return NotionConnector()
    elif connector_id == "granola":
        from nexify.connectors.granola import GranolaConnector
...
def ingest_sources(
    ...
    *,
    ...
    state_db:
        ...
        ``~/.nexify/sync_state.db`` when empty.
