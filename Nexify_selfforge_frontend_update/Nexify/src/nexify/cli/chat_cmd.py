...
from nexify.cli._tool_names import resolve_tool_names
...
def chat(
    ...
    # Resolve engine
    from nexify.engine import get_engine
    ...
    if agent_key and agent_key != "none":
        try:
            import nexify.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]nexify Chat[/green bold]\n"
