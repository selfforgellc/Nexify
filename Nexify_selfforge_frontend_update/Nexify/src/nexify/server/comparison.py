...
<title>nexify — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>nexify</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      nexify runs models on your own hardware. Every inference call that would
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install nexify and run AI locally
      with zero API costs.</div>
    <div class="code-block">
      <code>git clone https://github.com/open-jarvis/nexify.git
&& cd nexify && uv sync</code>
