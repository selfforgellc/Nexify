...
Recipes are the universal composition format for nexify.  Each recipe
...
_USER_RECIPES_DIR = Path.home() / ".nexify" / "recipes"
_USER_OPERATORS_DIR = Path.home() / ".nexify" / "operators"
...
class Recipe:
    ...
    def to_eval_suite(
        ...
        """
        from nexify.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from nexify.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.nexify/recipes/`` directory
    4. User ``~/.nexify/operators/`` directory
