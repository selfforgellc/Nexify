...
_EMAILS = [
    ...
    },
    {
        ...
        "body": "The SSL certificate for api.nexify.dev expires on December 12. Auto-renewal is configured but failed last time due to DNS validation issues. Please verify the CNAME record is correct and trigger a manual renewal if needed.",
        "urgency": "high",
        "category": "action",
    },
    {
