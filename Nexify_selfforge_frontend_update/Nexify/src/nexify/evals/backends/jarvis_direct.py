...
from nexify.evals.backends._commit_util import nexify_commit
...
class JarvisDirectBackend(InferenceBackend):
    ...
    def framework_commit_value(self) -> str:
        """nexify repo HEAD commit (for telemetry tagging)."""
        from nexify.evals.backends._commit_util import nexify_commit

        return nexify_commit()
    ...
    def generate_full(
        ...
        *,
        ...
        return {
            ...
            "turn_count": 1,
            "framework": "nexify",
            "framework_commit": nexify_commit(),
            "error": None,
        }
