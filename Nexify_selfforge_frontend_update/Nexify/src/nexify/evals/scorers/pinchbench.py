...
Provides transcript translation (nexify events → PinchBench format),
...
from nexify.evals.core.event_recorder import EventType
from nexify.evals.core.scorer import LLMJudgeScorer
from nexify.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: nexify name → PinchBench-expected name
# ---------------------------------------------------------------------------
