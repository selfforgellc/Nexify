...
from nexify.evals.core.config import EvalConfigError, expand_suite, load_eval_config
...
class TestCLIConfig:
    def test_run_missing_benchmark_and_config(self):
        ...
        from nexify.evals.cli import main
    ...
    def test_run_config_loads_and_prints_suite_info(self, tmp_path):
        ...
        runner = CliRunner()
        with patch("nexify.evals.cli._run_single", side_effect=Exception("mock")):
