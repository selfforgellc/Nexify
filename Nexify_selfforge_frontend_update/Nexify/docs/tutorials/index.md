---
title: Tutorials
description: Step-by-step guides for building with nexify
---

# Tutorials

Hands-on guides that walk through building real applications with nexify. Each tutorial includes a standalone script you can run immediately, a TOML recipe for configuration, and a detailed walkthrough of the concepts involved.

!!! note "Before you begin"
    All tutorials assume nexify is installed and an inference engine is running. If you have not completed setup yet, start with the [Quick Start guide](../getting-started/quickstart.md).
...
Each tutorial demonstrates a different combination of nexify primitives working together:
