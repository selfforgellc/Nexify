...
**By:** nexify team (Stanford Hazy Research); contact: [user fills in].
...
- License compatibility: Pearl is ISC; nexify is Apache-2.0. We don't see any conflict for either consumption (v1) or contribution (v3), but please flag if you do.
