...
from nexify.bench.energy import EnergyBenchmark
from nexify.core.registry import BenchmarkRegistry
from nexify.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from nexify.bench.energy import ensure_registered
