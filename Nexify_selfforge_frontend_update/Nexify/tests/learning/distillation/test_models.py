"""Tests for nexify.learning.distillation.models module."""
...
class TestEditPillar:
    ...
    def test_has_four_pillars(self) -> None:
        from nexify.learning.distillation.models import EditPillar
...
class TestEditRiskTier:
    ...
    def test_has_three_tiers(self) -> None:
        from nexify.learning.distillation.models import EditRiskTier
...
class TestEditOp:
    ...
    def test_intelligence_ops(self) -> None:
        from nexify.learning.distillation.models import EditOp
...
class TestTriggerKind:
    ...
    def test_four_trigger_kinds(self) -> None:
        from nexify.learning.distillation.models import TriggerKind
...
class TestAutonomyMode:
    ...
    def test_three_modes(self) -> None:
        from nexify.learning.distillation.models import AutonomyMode
...
class TestSessionStatus:
    ...
    def test_all_statuses(self) -> None:
        from nexify.learning.distillation.models import SessionStatus
...
class TestEdit:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nexify.learning.distillation.models import Edit
...
class TestFailureCluster:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nexify.learning.distillation.models import FailureCluster
...
class TestLearningPlan:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nexify.learning.distillation.models import LearningPlan
...
class TestBenchmarkSnapshot:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nexify.learning.distillation.models import BenchmarkSnapshot
...
class TestEditOutcome:
    ...
    def test_applied_outcome(self) -> None:
        from nexify.learning.distillation.models import EditOutcome
...
class TestLearningSession:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from nexify.learning.distillation.models import LearningSession
