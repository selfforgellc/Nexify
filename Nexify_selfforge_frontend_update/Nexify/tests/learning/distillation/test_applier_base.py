"""Tests for nexify.learning.distillation.execute.base module."""
...
class TestApplyContext:
    ...
    def test_constructs(self, tmp_path: Path) -> None:
        ...
        assert ctx.nexify_home == tmp_path
...
class TestValidationResult:
    ...
    def test_ok_result(self) -> None:
        from nexify.learning.distillation.execute.base import ValidationResult
...
class TestEditApplierRegistry:
    ...
    def test_register_and_get(self) -> None:
        from nexify.learning.distillation.execute.base import (
            ApplyContext,
            ApplyResult,
            EditApplier,
            EditApplierRegistry,
        ...
        from nexify.learning.distillation.models import Edit, EditOp
