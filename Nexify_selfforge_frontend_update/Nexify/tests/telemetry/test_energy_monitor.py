...
class TestCreateEnergyMonitor:
    def test_returns_none_when_nothing_available(self):
        with (
            patch(
                "nexify.telemetry.energy_nvidia.NvidiaEnergyMonitor.available",
                return_value=False,
            ),
            patch(
                "nexify.telemetry.energy_amd.AmdEnergyMonitor.available",
                return_value=False,
            ),
            patch(
                "nexify.telemetry.energy_apple.AppleEnergyMonitor.available",
                return_value=False,
            ),
            patch(
                "nexify.telemetry.energy_rapl.RaplEnergyMonitor.available",
                return_value=False,
            ),
        ):
    ...
    def test_prefer_vendor_parameter(self):
        ...
        with (
            ...
            patch(
                "nexify.telemetry.energy_rapl.RaplEnergyMonitor.__init__",
                return_value=None,
            ) as mock_init,
        ):
    ...
    def test_detection_order_nvidia_first(self):
        ...
        with (
            ...
            patch(
                "nexify.telemetry.energy_nvidia.NvidiaEnergyMonitor.__init__",
                return_value=None,
            ),
        ):
            create_energy_monitor()
    ...
    def test_detection_order_falls_through(self):
        ...
        with (
            ...
            patch(
                "nexify.telemetry.energy_amd.AmdEnergyMonitor.__init__",
                return_value=None,
            ),
        ):
            create_energy_monitor()
