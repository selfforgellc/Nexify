...
def test_mine_doctor_prints_capability_matrix(hopper_hw):
    ...
    runner = CliRunner()
    with (
        patch("nexify.cli.mine_cmd._detect_hardware", return_value=hopper_hw),
        patch(
            "nexify.cli.mine_cmd.check_docker_available",
            return_value=(True, "running 24.0.7"),
        ),
        patch(
            "nexify.cli.mine_cmd.check_disk_free",
            return_value=(True, "300 GB free"),
        ),
        patch(
            "nexify.cli.mine_cmd.check_pearld_reachable",
...
def test_mine_doctor_flags_unsupported_hardware(ada_hw):
    ...
    runner = CliRunner()
    with (
        patch("nexify.cli.mine_cmd._detect_hardware", return_value=ada_hw),
        patch(
            "nexify.cli.mine_cmd.check_docker_available",
...
def test_mine_logs_streams_container_output():
    ...
    with patch("nexify.cli.mine_cmd._docker_from_env", return_value=fake_client):
