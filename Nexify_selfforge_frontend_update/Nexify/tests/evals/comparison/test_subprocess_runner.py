"""Tests for nexify.evals.backends.external._subprocess_runner."""
...
from nexify.evals.backends.external._subprocess_runner import (
    EnergySample,
    SubprocessResult,
    run_one_shot,
)
...
class TestEnergySampler:
    def test_fallback_chain_reaches_unavailable(
        ...
        from nexify.evals.backends.external import _subprocess_runner as m
