...
class TestCostCalculator:
    ...
    def test_estimate_monthly_cost(self) -> None:
        from nexify.server.cost_calculator import estimate_monthly_cost
    ...
    def test_estimate_scenario(self) -> None:
        from nexify.server.cost_calculator import estimate_scenario
    ...
    def test_estimate_all_scenarios(self) -> None:
        from nexify.server.cost_calculator import estimate_all_scenarios
...
class TestSavings:
    ...
    def test_compute_savings_basic(self) -> None:
        from nexify.server.savings import compute_savings
    ...
    def test_savings_to_dict(self) -> None:
        from nexify.server.savings import compute_savings, savings_to_dict
    ...
    def test_energy_wh_matches_direct_formula(self) -> None:
        ...
        from nexify.server.savings import CLOUD_PRICING, compute_savings
