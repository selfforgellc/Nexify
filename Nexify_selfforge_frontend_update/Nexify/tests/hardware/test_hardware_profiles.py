...
class TestDetectHardware:
    ...
    @patch("nexify.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "nexify.core.config._run_cmd",
    ...
    @patch("nexify.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "nexify.core.config._run_cmd",
        side_effect=[
    ...
    @patch("nexify.core.config.platform.system", return_value="Darwin")
    @patch(
        "nexify.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("nexify.core.config.shutil.which", return_value=None)
    @patch("nexify.core.config.platform.system", return_value="Linux")
