...
class TestBrowserNavigateTool:
    def test_spec_name_and_category(self):
        from nexify.tools.browser import BrowserNavigateTool
    ...
    def test_execute_playwright_not_installed(self):
        ...
        with patch("nexify.tools.browser._session", session):
            tool = BrowserNavigateTool()
    ...
    def test_execute_ssrf_blocked(self):
        ...
        with patch.dict(
            "sys.modules",
            {"nexify.security.ssrf": mock_ssrf_module},
        ):
            tool = BrowserNavigateTool()
    ...
    def test_execute_ssrf_module_missing(self):
        ...
        def _mock_import(name, *args, **kwargs):
            if name == "nexify.security.ssrf":
                raise ImportError("No module named 'nexify.security.ssrf'")
...
class TestBrowserClickTool:
    def test_spec_name_and_category(self):
        from nexify.tools.browser import BrowserClickTool
...
class TestBrowserTypeTool:
    def test_spec_name_and_category(self):
        from nexify.tools.browser import BrowserTypeTool
...
class TestBrowserScreenshotTool:
    def test_spec_name_and_category(self):
        from nexify.tools.browser import BrowserScreenshotTool
...
class TestBrowserExtractTool:
    def test_spec_name_and_category(self):
        from nexify.tools.browser import BrowserExtractTool
...
class TestBrowserSession:
    def test_session_close_resets_state(self):
        from nexify.tools.browser import _BrowserSession
...
class TestRegistryIntegration:
    def test_all_tools_registered(self):
        ...
        from nexify.tools.browser import (
            BrowserClickTool,
            BrowserExtractTool,
            BrowserNavigateTool,
    ...
    def test_module_exports(self):
        from nexify.tools.browser import __all__
