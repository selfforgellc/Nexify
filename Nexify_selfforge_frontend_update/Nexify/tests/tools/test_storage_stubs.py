...
class TestStorageStubs:
    ...
    def test_backward_compat_import(self) -> None:
        ...
        from nexify.tools.storage._stubs import MemoryBackend as MB
        from nexify.tools.storage._stubs import RetrievalResult as RR
    ...
    def test_sqlite_backward_compat(self) -> None:
        ...
        from nexify.tools.storage.sqlite import SQLiteMemory as S1
