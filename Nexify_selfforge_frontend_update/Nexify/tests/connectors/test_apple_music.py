...
def connector():
    ...
    from nexify.connectors.apple_music import AppleMusicConnector
...
def test_is_connected_on_macos(connector):
    ...
    with (
        patch("nexify.connectors.apple_music.sys") as mock_sys,
        patch("nexify.connectors.apple_music.subprocess") as mock_subprocess,
    ):
...
def test_is_connected_on_linux(connector):
    ...
    with patch("nexify.connectors.apple_music.sys") as mock_sys:
...
def test_sync_yields_tracks(connector):
    ...
    with patch(
        "nexify.connectors.apple_music._run_osascript",
