...
def connector(tmp_path: Path):
    ...
    from nexify.connectors.notion import NotionConnector  # noqa: PLC0415
...
@patch("nexify.connectors.notion._notion_api_search")
@patch("nexify.connectors.notion._notion_api_get_blocks")
...
def test_render_blocks_to_markdown() -> None:
    ...
    from nexify.connectors.notion import _render_blocks_to_markdown  # noqa: PLC0415
