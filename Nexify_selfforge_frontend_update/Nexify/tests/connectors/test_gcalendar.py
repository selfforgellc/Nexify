...
def connector(tmp_path: Path):
    ...
    from nexify.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "nexify.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("nexify.connectors.gcalendar._gcal_api_calendars_list")
@patch("nexify.connectors.gcalendar._gcal_api_events_list")
