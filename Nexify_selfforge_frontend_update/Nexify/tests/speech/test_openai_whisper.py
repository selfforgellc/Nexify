...
from nexify.core.registry import SpeechRegistry
from nexify.speech._stubs import TranscriptionResult
from nexify.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("nexify.speech.openai_whisper.OpenAI", return_value=mock_client):
        from nexify.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("nexify.speech.openai_whisper.OpenAI"):
        from nexify.speech.openai_whisper import OpenAIWhisperBackend
