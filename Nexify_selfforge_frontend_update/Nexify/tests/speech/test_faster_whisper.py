...
from nexify.speech.faster_whisper import FasterWhisperBackend
...
def test_faster_whisper_transcribe():
    ...
    with patch(
        "nexify.speech.faster_whisper.WhisperModel",
...
def test_faster_whisper_supported_formats():
    ...
    with patch("nexify.speech.faster_whisper.WhisperModel"):
        from nexify.speech.faster_whisper import FasterWhisperBackend
