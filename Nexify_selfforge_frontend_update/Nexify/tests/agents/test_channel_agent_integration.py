...
from nexify.agents.channel_agent import ChannelAgent
...
def test_quick_query_inline_response(tmp_path: Path) -> None:
    ...
    containing calendar info and NO nexify:// link.
    """
    ...
    assert "nexify://" not in sent_content, (
