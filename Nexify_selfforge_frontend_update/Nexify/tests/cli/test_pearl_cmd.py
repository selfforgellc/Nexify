...
def test_pearl_doctor_reports_discovered_binaries(monkeypatch) -> None:
    ...
    monkeypatch.setattr("nexify.cli.pearl_cmd._resolve_binary", fake_resolve)
...
def test_pearl_node_passes_args_to_pearld(monkeypatch) -> None:
    ...
    monkeypatch.setattr("nexify.cli.pearl_cmd._run", fake_run)
...
def test_pearl_address_uses_wallet_rpc(monkeypatch) -> None:
    ...
    monkeypatch.setattr("nexify.cli.pearl_cmd._run_capture", fake_capture)
