...
from nexify.security.ssrf import _check_ssrf_python, check_ssrf, is_private_ip
...
class TestCheckSsrf:
    ...
    def test_allows_normal_urls(self):
        ...
        with patch("nexify.security.ssrf.socket.getaddrinfo") as mock_dns:
    ...
    def test_dns_failure_allowed(self):
        ...
        with patch(
            "nexify.security.ssrf.socket.getaddrinfo",
