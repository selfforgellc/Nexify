...
class TestGetRustModule:
    ...
    def test_returns_rust_module(self):
        """get_rust_module() returns the nexify_rust module."""
        from nexify._rust_bridge import get_rust_module

        get_rust_module.cache_clear()
        result = get_rust_module()
        assert result is not None
        assert hasattr(result, "__name__")
        assert result.__name__ == "nexify_rust"
...
class TestScanResultFromJson:
    ...
    def test_empty_findings(self):
        from nexify._rust_bridge import scan_result_from_json
...
class TestInjectionResultFromJson:
    ...
    def test_clean(self):
        from nexify._rust_bridge import injection_result_from_json
...
class TestRetrievalResultsFromJson:
    ...
    def test_empty(self):
        from nexify._rust_bridge import retrieval_results_from_json
...
class TestRustBackedModules:
    ...
    def test_rate_limiter_uses_rust(self):
        ...
        from nexify.security.rate_limiter import RateLimiter
