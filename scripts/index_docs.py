#!/usr/bin/env python3
"""Index nexify docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual nexify docs the boilerplate that
    # crowds retrieval ("nexify runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does nexify support?",
