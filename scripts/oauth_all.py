...
CONFIG_DIR = Path.home() / ".nexify" / "connectors"
...
GOOGLE_CLIENT_ID = (
    os.environ.get("nexify_GOOGLE_CLIENT_ID", "") or _google["client_id"]
)
GOOGLE_CLIENT_SECRET = (
    os.environ.get("nexify_GOOGLE_CLIENT_SECRET", "")
    or _google["client_secret"]
)

_strava = _load_creds("strava.json")
STRAVA_CLIENT_ID = (
    os.environ.get("nexify_STRAVA_CLIENT_ID", "") or _strava["client_id"]
)
STRAVA_CLIENT_SECRET = (
    os.environ.get("nexify_STRAVA_CLIENT_SECRET", "")
    or _strava["client_secret"]
)

_spotify = _load_creds("spotify.json")
SPOTIFY_CLIENT_ID = (
    os.environ.get("nexify_SPOTIFY_CLIENT_ID", "") or _spotify["client_id"]
)
SPOTIFY_CLIENT_SECRET = (
    os.environ.get("nexify_SPOTIFY_CLIENT_SECRET", "")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run OAuth flows for nexify connectors"
    )
