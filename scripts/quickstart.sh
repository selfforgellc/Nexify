...
uv run maturin develop -m rust/crates/nexify-python/Cargo.toml --quiet 2>/dev/null \
...
echo ""
echo -e "${GREEN}${BOLD}  nexify is running!${NC}"
echo ""
