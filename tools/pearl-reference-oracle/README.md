# Pearl reference oracle (nexify Phase 0 deliverable)
...
If it succeeds, this host can mine Pearl using the nexify `cpu-pearl` provider
...
- When Pearl bumps `py-pearl-mining` API: re-run the smoke test against the
  new ref pinned in `nexify/src/nexify/mining/_constants.py`.
