---
title: Code Snippets
description: Copy-paste patterns for common nexify tasks
---

# Code Snippets

Ready-to-use patterns for the most common nexify tasks. Each snippet is self-contained and copy-pasteable.
...
```bash
docker build -t nexify .
docker run -p 8000:8000 nexify serve --host 0.0.0.0
```
