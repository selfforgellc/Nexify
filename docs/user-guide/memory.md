...
- **Persistence:** SQLite database file (default: `~/.nexify/memory.db`)
...
```python
from nexify.tools.storage.bm25 import BM25Memory
...
!!! note "Backward compatibility"
    The old `from nexify.memory.bm25 import BM25Memory` still works via backward-compatibility shims, but new code should use the canonical `nexify.tools.storage.*` imports.
...
[Source: docs/intro.md] nexify is a modular AI framework...
