...
The default path is `~/.nexify/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/nexify/security/index.md) — complete class and function signatures
