...
REAL_WORLD_MENTIONS = [
    # === QUESTIONs that should ground (docs cover them) ===
    {
        ...
        "text": (
            "@nexifyAI does this work with vllm or "
    ...
    },
    {
        ...
        "author": "indie_hacker",
        "text": (
            "@nexifyAI can I run the orchestrator agent "
    ...
    },
    {
        ...
        "author": "macuser",
        "text": "@nexifyAI how do I install on macos with apple silicon?",
    },
    {
        "id": "3000000000000000004",
        "author": "longwinded_lou",
        "text": (
            "@nexifyAI how does the memory system handle "
    ...
    # === QUESTIONs that should defer (off-topic / unknowable) ===
    {
        ...
        "text": "@nexifyAI what's the weather in tokyo today?",
    },
    {
        "id": "3000000000000000006",
        "author": "specific_specs",
        "text": (
            "@nexifyAI what's the exact tokens-per-second "
    ...
    # === BUG / FEATURE / PRAISE / SPAM ===
    {
        ...
        "author": "devops_dan",
        "text": (
            "@nexifyAI getting a segfault on startup "
    ...
    },
    {
        ...
        "text": (
            "@nexifyAI any plans for SSO support? "
    ...
    },
    {
        ...
        "author": "convert_carl",
        "text": (
            "@nexifyAI switched from langchain last week, this is incredible"
        ),
    },
    {
        "id": "3000000000000000010",
        "author": "crypto_bro",
        "text": "@nexifyAI BUY $JARVIS COIN guaranteed 10x gains link in bio",
    },
]
