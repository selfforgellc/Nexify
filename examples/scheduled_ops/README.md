...
This tutorial demonstrates how to use nexify to run **autonomous scheduled agents** that perform recurring personal tasks on a cron-like schedule.
...
- **Model selection**: Use `--model` to target a specific model, or let nexify auto-select from what is available.
