...
from nexify.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
...
class TestToolExecutorIntegration:
    ...
    def test_calculator_and_think(self):
        _register_tools()
        from nexify.tools._stubs import ToolExecutor
        from nexify.tools.calculator import CalculatorTool
        from nexify.tools.think import ThinkTool
...
class TestSDKImport:
    """Verify Jarvis class is importable from nexify."""
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        with patch("nexify.sdk.get_engine", return_value=("mock", engine)):
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from nexify.core.config import JarvisConfig
        from nexify.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from nexify.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from nexify.bench import ensure_registered
        from nexify.bench._stubs import BenchmarkSuite
        from nexify.core.registry import BenchmarkRegistry
