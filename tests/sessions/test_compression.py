...
from nexify.core.registry import CompressionRegistry
...
def _register_compressors():
    ...
    from nexify.sessions.compression import (
        ModelSummarization,
...
def test_rule_based_strips_tool_boilerplate():
    from nexify.sessions.compression import RuleBasedPrecompression
...
def test_session_consolidation_preserves_recent():
    from nexify.sessions.compression import SessionConsolidation
...
def test_tiered_summaries_gradient():
    from nexify.sessions.compression import TieredSummaries
