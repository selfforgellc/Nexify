...
def connector(tmp_path: Path):
    ...
    from nexify.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("nexify.connectors.gdrive._gdrive_api_list_files")
@patch("nexify.connectors.gdrive._gdrive_api_export")
