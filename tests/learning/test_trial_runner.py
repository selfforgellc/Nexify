"""Tests for nexify.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from nexify.evals.core.types import RunConfig, RunSummary
from nexify.learning.optimize.trial_runner import TrialRunner
from nexify.learning.optimize.types import TrialConfig, TrialResult
...
class TestRunTrial:
    ...
    @patch("nexify.evals.cli._build_scorer")
    @patch("nexify.evals.cli._build_judge_backend")
    @patch("nexify.evals.cli._build_dataset")
    @patch("nexify.evals.cli._build_backend")
    @patch("nexify.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from nexify.evals.core.types import EvalResult
