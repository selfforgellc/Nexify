"""Tests for nexify.learning.distillation.diagnose.types module."""
...
class TestTraceMeta:
    ...
    def test_constructs_with_required_fields(self) -> None:
        from nexify.learning.distillation.diagnose.types import TraceMeta
...
class TestBenchmarkTask:
    ...
    def test_constructs(self) -> None:
        from nexify.learning.distillation.diagnose.types import BenchmarkTask
...
class TestStudentRun:
    ...
    def test_constructs(self) -> None:
        from nexify.learning.distillation.diagnose.types import StudentRun
...
class TestTeacherRun:
    ...
    def test_constructs(self) -> None:
        from nexify.learning.distillation.diagnose.types import TeacherRun
...
class TestComparisonResult:
    ...
    def test_constructs(self) -> None:
        from nexify.learning.distillation.diagnose.types import ComparisonResult
...
class TestToolMeta:
    ...
    def test_constructs(self) -> None:
        from nexify.learning.distillation.diagnose.types import ToolMeta
...
class TestDiagnosticTool:
    ...
    def test_constructs_with_callable(self) -> None:
        from nexify.learning.distillation.diagnose.types import DiagnosticTool
...
class TestToolCallRecord:
    ...
    def test_constructs(self) -> None:
        from nexify.learning.distillation.diagnose.types import ToolCallRecord
