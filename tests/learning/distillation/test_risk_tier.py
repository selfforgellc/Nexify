"""Tests for nexify.learning.distillation.plan.risk_tier module."""
...
class TestTierTable:
    ...
    def test_every_edit_op_has_a_tier(self) -> None:
        ...
        from nexify.learning.distillation.plan.risk_tier import TIER_TABLE
...
class TestAssignTier:
    ...
    def test_intelligence_ops_are_auto(self) -> None:
        from nexify.learning.distillation.models import EditOp, EditRiskTier
        from nexify.learning.distillation.plan.risk_tier import assign_tier
...
class TestAssignTiers:
    ...
    def test_overwrites_teacher_tier(self) -> None:
        ...
        from nexify.learning.distillation.plan.risk_tier import assign_tiers
