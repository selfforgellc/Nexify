...
class TestGRPOConfig:
    def test_default_config(self) -> None:
        from nexify.core.config import GRPOConfig
...
class TestDefaultRewardFn:
    def test_score_returns_float(self) -> None:
        from nexify.learning.intelligence.grpo_trainer import DefaultRewardFn
...
class TestGRPOTrainer:
    def test_init(self) -> None:
        from nexify.core.config import GRPOConfig
        from nexify.learning.intelligence.grpo_trainer import GRPOTrainer
