...
class TestSigning:
    def test_generate_keypair(self):
        ...
        from nexify.security.signing import generate_keypair
    ...
    def test_sign_and_verify(self):
        _skip_if_no_cryptography()
        from nexify.security.signing import generate_keypair, sign, verify
    ...
    def test_sign_b64(self):
        _skip_if_no_cryptography()
        from nexify.security.signing import generate_keypair, sign_b64, verify_b64
    ...
    def test_verify_b64_invalid(self):
        _skip_if_no_cryptography()
        from nexify.security.signing import generate_keypair, verify_b64
    ...
    def test_save_and_load_keypair(self, tmp_path):
        _skip_if_no_cryptography()
        from nexify.security.signing import (
            generate_keypair,
            load_public_key,
            save_keypair,
            sign,
