"""Tests for nexify.evals.backends.external.openclaw.OpenClawBackend."""
...
class TestOpenClawBackend:
    def test_generate_full_builds_correct_subprocess_command(
        ...
        with (
            patch(
                "nexify.evals.backends.external.openclaw.load_third_party_config",
                return_value=cfg,
            ),
            patch(
                "nexify.evals.backends.external.openclaw.verify_commit_pin",
            ),
            patch(
                "nexify.evals.backends.external.openclaw.run_one_shot",
            ) as mock_run,
        ):
