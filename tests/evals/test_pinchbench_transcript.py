...
from nexify.evals.core.event_recorder import AgentEvent, EventType
from nexify.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from nexify.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """nexify tool names are mapped to PinchBench-expected names."""
    from nexify.evals.scorers.pinchbench import events_to_transcript
