...
from nexify.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from nexify.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from nexify.evals.core.runner import _result_to_trace_dict
...
class TestDirectBackendGpuMetrics:
    ...
    @patch("nexify.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("nexify.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from nexify.evals.core.config import expand_suite
