...
from nexify.evals.scorers.lifelong_agent_scorer import (
    LifelongAgentScorer,
...
class TestDBEnvironment:
    def test_multi_turn_select(self) -> None:
        ...
        from nexify.evals.environments.lifelong_agent_env import DBEnvironment
...
class TestKGEnvironment:
    def test_multi_turn_with_oracle(self) -> None:
        ...
        from nexify.evals.environments.lifelong_agent_env import KGEnvironment
...
class TestOSEnvironment:
    def test_requires_docker(self) -> None:
        ...
        from nexify.evals.environments.lifelong_agent_env import OSEnvironment
...
class TestMaxTurns:
    def test_db_max_turns(self) -> None:
        from nexify.evals.environments.lifelong_agent_env import (
            MAX_TURNS_DB,
            DBEnvironment,
        )
    ...
    def test_base_default(self) -> None:
        from nexify.evals.environments.base import TaskEnvironment
