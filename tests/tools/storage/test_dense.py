...
from nexify.tools.storage.dense import (
    DenseMemory,
    MdChunk,
    chunk_markdown,
    dedupe_chunks,
...
class TestDedupeChunks:
    ...
    def test_dedupes_boilerplate_across_three_files(self):
        ...
        body = "nexify runs entirely on your hardware no cloud needed local first"
        chunks = [
    ...
    def test_minor_edit_is_clustered_when_body_is_long_enough(self):
        ...
        """
        common = (
            "nexify is a personal ai platform that runs entirely on your "
    ...
    def test_breadcrumb_difference_does_not_block_dedupe(self):
        ...
        """
        body = (
            "nexify runs entirely on your hardware no cloud needed "
    ...
    def test_does_not_remove_more_than_corpus(self):
        ...
        body = "boilerplate about how nexify runs entirely on your hardware locally"
