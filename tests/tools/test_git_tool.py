...
``nexify_rust`` extension is not required.  The mock simulates Rust
...
from nexify.tools.git_tool import (
    GitCommitTool,
    GitDiffTool,
    GitLogTool,
    GitStatusTool,
...
def _make_mock_rust(tmp_path=None):
    """Return a mock module mimicking ``nexify_rust`` git tools.
...
class TestGitStatusTool:
    ...
    def test_clean_repo(self, tmp_path):
        ...
        with patch("nexify.tools.git_tool.get_rust_module", return_value=mock_mod):
...
class TestGitCommitTool:
    ...
    def test_git_not_found(self):
        tool = GitCommitTool()
        with patch("nexify.tools.git_tool.shutil.which", return_value=None):
