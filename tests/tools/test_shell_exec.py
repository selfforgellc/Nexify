...
from nexify.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        import nexify.tools as tools_pkg
        from nexify.core.registry import ToolRegistry

        sys.modules.pop("nexify.tools.shell_exec", None)
    ...
    def test_env_clearing(self):
        ...
        marker = "nexify_TEST_SECRET_12345"
    ...
    def test_env_passthrough(self):
        ...
        marker = "nexify_TEST_PASSTHROUGH_67890"
