...
class TestDigestScheduleCLI:
    ...
    def test_schedule_show_status(self):
        ...
        runner = CliRunner()
        with patch("nexify.cli.digest_cmd.load_config", return_value=mock_cfg):
    ...
    def test_schedule_set_cron(self, tmp_path):
        ...
        with (
            patch(
                "nexify.cli.digest_cmd.load_config",
                return_value=mock_cfg,
            ),
            patch(
                "nexify.cli.digest_cmd.DEFAULT_CONFIG_PATH",
                config_path,
            ),
            patch(
                "nexify.cli.digest_cmd._create_scheduler_task",
                return_value="abc123",
            ) as mock_create,
        ):
    ...
    def test_schedule_off(self):
        ...
        with (
            ...
            patch("nexify.cli.digest_cmd._save_digest_schedule") as mock_save,
            patch(
                "nexify.cli.digest_cmd._cancel_scheduler_tasks",
                return_value=1,
            ),
        ):
...
class TestDigestScheduleEndpoints:
    ...
    def test_schedule_endpoint_returns_config(self, client):
        ...
        with patch(
            "nexify.server.digest_routes.load_config",
            return_value=mock_cfg,
        ):
    ...
    def test_schedule_endpoint_update(self, client):
        ...
        with (
            ...
            patch("nexify.server.digest_routes._save_digest_schedule") as mock_save,
            patch(
                "nexify.server.digest_routes._create_scheduler_task",
    ...
    def test_schedule_endpoint_disable(self, client):
        ...
        with (
            ...
            patch("nexify.server.digest_routes._save_digest_schedule") as mock_save,
            patch(
                "nexify.server.digest_routes._cancel_scheduler_tasks",
                return_value=1,
            ) as mock_cancel,
        ):
            resp = client.post(
