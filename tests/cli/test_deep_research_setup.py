...
def test_detect_local_sources(tmp_path: Path) -> None:
    ...
    from nexify.cli.deep_research_setup_cmd import detect_local_sources
...
def test_ingest_sources(tmp_path: Path) -> None:
    ...
    from nexify.cli.deep_research_setup_cmd import (
...
def test_detect_token_sources_finds_connected(tmp_path: Path) -> None:
    ...
    from nexify.cli.deep_research_setup_cmd import detect_token_sources
