...
class TestQuickstartCommand:
    ...
    def test_happy_path(self, tmp_path):
        ...
        with (
            patch("nexify.cli.quickstart_cmd.detect_hardware", return_value=hw),
            patch("nexify.cli.quickstart_cmd.DEFAULT_CONFIG_PATH", config_path),
            patch("nexify.cli.quickstart_cmd.DEFAULT_CONFIG_DIR", tmp_path),
            patch(
                "nexify.cli.quickstart_cmd.generate_default_toml",
                return_value="[engine]\n",
            ),
            patch(
                "nexify.cli.quickstart_cmd.recommend_engine",
                return_value="ollama",
            ),
            patch(
                "nexify.cli.quickstart_cmd._check_engine_health",
                return_value=True,
            ),
            patch(
                "nexify.cli.quickstart_cmd._check_model_available",
                return_value=True,
            ),
            patch(
                "nexify.cli.quickstart_cmd._test_query",
                return_value="Hello!",
            ),
        ):
            runner = CliRunner()
    ...
    def test_force_regenerates_config(self, tmp_path):
        ...
        with (
            ...
            patch("nexify.cli.quickstart_cmd._test_query", return_value="Hello!"),
        ):
            runner = CliRunner()
    ...
    def test_falls_back_to_any_healthy_engine(self, tmp_path):
        ...
        with (
            ...
            patch(
                "nexify.cli.quickstart_cmd._discover_healthy_engines",
                return_value=["ollama"],
            ),
            patch(
                "nexify.cli.quickstart_cmd._check_model_available",
