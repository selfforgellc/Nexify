...
from nexify.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("nexify.speech.deepgram.DeepgramClient", return_value=mock_client):
        from nexify.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("nexify.speech.deepgram.DeepgramClient"):
        from nexify.speech.deepgram import DeepgramSpeechBackend
