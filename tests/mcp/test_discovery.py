...
_PATCH_HTTP = "nexify.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "nexify.mcp.transport.StdioTransport"
_PATCH_CLIENT = "nexify.mcp.client.MCPClient"
_PATCH_PROVIDER = "nexify.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "nexify.system.builder.logger"
