...
Thank you for your interest in contributing to nexify! This guide covers everything you need to know — from why to contribute, to how to submit your first pull request.

---

## Why Contribute?

Contributing to nexify isn't just about code — it's about building the future of on-device AI together. Here's what you get:

### Paper Acknowledgment

All contributors with merged pull requests will be acknowledged as contributors on the nexify paper release.

### Mac Mini Giveaway

We're giving away a Mac Mini to one lucky contributor! Install nexify on your personal machine and opt in via the desktop app to share anonymized savings data (FLOPs, dollar cost, energy) for a chance to win. Your data is fully anonymous — no IP, no hardware info beyond savings metrics. You must share your email via the desktop app to be eligible.

See the [Savings Leaderboard](https://open-jarvis.github.io/nexify/leaderboard/) for details.
...
Look for issues labeled [`good-first-issue`](https://github.com/open-jarvis/nexify/labels/good-first-issue).
...
1. Browse the [Roadmap](https://open-jarvis.github.io/nexify/development/roadmap/) for an item that interests you
2. Check if a [GitHub issue](https://github.com/open-jarvis/nexify/issues) already exists for it — if not, [open one](https://github.com/open-jarvis/nexify/issues/new/choose) describing what you'd like to work on
...
Use the appropriate [issue template](https://github.com/open-jarvis/nexify/issues/new/choose):
...
nexify is built on five composable primitives. Here's where you can contribute:
...
- Open a [Discussion](https://github.com/open-jarvis/nexify/discussions) for questions and help
- Check the [documentation](https://open-jarvis.github.io/nexify/) for guides and API reference
