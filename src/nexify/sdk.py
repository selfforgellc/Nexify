"""High-level Python SDK for nexify."""
...
import nexify
from nexify.core.config import JarvisConfig, load_config
from nexify.core.events import EventBus
from nexify.core.types import Message, Role
from nexify.engine._discovery import get_engine
...
class MemoryHandle:
    ...
    def _get_backend(self) -> Any:
        ...
        import nexify.tools.storage  # noqa: F401
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from nexify.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from nexify.tools.storage.chunking import ChunkConfig
...
class Jarvis:
    ...
    def version(self) -> str:
        """Return the nexify version string."""
        return nexify.__version__
    ...
    def _run_agent(
        ...
        *,
        ...
        import nexify.agents  # noqa: F401
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from nexify.tools.digest_collect import DigestCollectTool
            from nexify.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from nexify.cli.ask import _get_memory_backend
