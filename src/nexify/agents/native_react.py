...
Renamed from ``ReActAgent`` to clarify this is nexify's native
...
from nexify.agents.prompt_loader import (
...
from nexify.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
from nexify.engine._stubs import InferenceEngine
from nexify.tools._stubs import BaseTool, build_tool_descriptions
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if self._skill_few_shot_examples:
            ...
            skill_examples_block = ""
        # Respect $nexify_HOME override for the base template (M2+ work).
        prompt_template = (
