"""MCP Server — wraps nexify tools as MCP-discoverable tools."""
...
from nexify.core.types import ToolCall
...
class MCPServer:
    """MCP server that exposes nexify tools via JSON-RPC.
    ...
    def _auto_discover_tools() -> List[BaseTool]:
        ...
        try:
            ...
            pass
        try:
            from nexify.tools.web_search import WebSearchTool
        ...
        # Storage MCP tools
        try:
            from nexify.tools.storage_tools import (
                MemoryIndexTool,
                MemoryRetrieveTool,
                MemorySearchTool,
                MemoryStoreTool,
        ...
        # Channel MCP tools
        try:
            from nexify.tools.channel_tools import (
                ChannelListTool,
                ChannelSendTool,
                ChannelStatusTool,
            )
