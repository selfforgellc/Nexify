...
_OUTPUT_START = "---nexify_OUTPUT_START---"
_OUTPUT_END = "---nexify_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``nexify-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "nexify-sandbox:latest"
    DEFAULT_TIMEOUT = 300
