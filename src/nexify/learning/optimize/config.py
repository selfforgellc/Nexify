...
from nexify.learning.optimize.types import ObjectiveSpec
...
def load_objectives(data: Dict[str, Any]) -> List[ObjectiveSpec]:
    ...
    """
    from nexify.learning.optimize.types import DEFAULT_OBJECTIVES
...
def load_benchmark_specs(data: Dict[str, Any]) -> List[Any]:
    ...
    """
    from nexify.learning.optimize.trial_runner import BenchmarkSpec
