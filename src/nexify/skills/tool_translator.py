"""ToolTranslator — translate external tool names to nexify equivalents.

External skill libraries (Hermes Agent, OpenClaw) reference tools by Claude
Code's standard tool names (Bash, Read, Write, etc.).  nexify uses
...
# ---------------------------------------------------------------------------
# Translation table — external name → nexify name
# ---------------------------------------------------------------------------
