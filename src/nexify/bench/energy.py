...
from nexify.bench._stats import compute_stats
from nexify.bench._stubs import BaseBenchmark, BenchmarkResult
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if energy_monitor is not None:
            from nexify.telemetry.steady_state import SteadyStateDetector
