...
from nexify.agents._stubs import AgentContext, BaseAgent
from nexify.core.events import Event, EventBus, EventType
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("nexify.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from nexify.core.types import Message as MsgType
                    from nexify.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("nexify.server")
                    _logger.warning(
