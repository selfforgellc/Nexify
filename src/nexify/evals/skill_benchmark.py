...
class SkillBenchmarkConfig:
    ...
    skills_dir: Path = field(
        default_factory=lambda: Path("~/.nexify/skills/").expanduser()
    )
    overlay_dir_dspy: Path = field(
        default_factory=lambda: Path("~/.nexify/learning/skills-dspy/").expanduser()
    )
    overlay_dir_gepa: Path = field(
        default_factory=lambda: Path("~/.nexify/learning/skills-gepa/").expanduser()
    )
...
class SkillBenchmarkRunner:
    ...
    def __init__(self, config: SkillBenchmarkConfig) -> None:
        ...
        # the default ~/.nexify/learning/skills/ tree.
