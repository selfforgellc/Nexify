"""Shared helper for resolving the nexify repo's HEAD commit."""
...
def nexify_commit() -> str:
    """Return the nexify repo's HEAD commit (cached, lru-1).
    ...
    """
    try:
        # Walk up to repo root: backends/ -> evals/ -> nexify/ -> src/ -> repo
